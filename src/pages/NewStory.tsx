...
export default function NewStory() {
    ...
    return (
        <div style={{ background: '#eee', padding: '20px' }}>
            <div style={{ maxWidth: '1000px', margin: 'auto', background: 'white', padding: '20px', border: '1px solid #3E2723' }}>
                <h2 style={{ background: '#3E2723', color: 'white', padding: '10px' }}>POST NEW WORK</h2>
                <input placeholder="Title" value={title} onChange={e => setTitle(e.target.value)} style={{ width: '100%', padding: '10px', marginBottom: '15px' }} />
                ...
                <div style={{ marginTop: '20px', display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
                    ...
                    <button onClick={() => handlePost('published')} style={{ padding: '10px 20px', background: '#3E2723', color: 'white' }}>POST WORK</button>
                </div>
            </div>
        </div>
    );
